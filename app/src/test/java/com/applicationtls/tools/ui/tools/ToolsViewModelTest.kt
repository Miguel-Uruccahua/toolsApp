...
class ToolsViewModelTest {
    ...
    fun uiState_initiallyLoading() = runTest {
        val viewModel = ToolsViewModel(FakeToolsRepository())
        assertEquals(viewModel.uiState.first(), ToolsUiState.Loading)
    }
...
private class FakeToolsRepository : ToolsRepository {
